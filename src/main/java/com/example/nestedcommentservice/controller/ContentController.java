...
public class ContentController {
    ...
    public ResponseEntity getContent(@RequestParam @NonNull String parentContentId, @RequestParam @NonNull Integer level,
                                     @RequestParam Integer page, @RequestParam Integer size) throws Exception {
        try {
            return new ResponseEntity<>(contentService.getContent(parentContentId, level, page, size), HttpStatus.OK);
        } catch (Exception e) {
